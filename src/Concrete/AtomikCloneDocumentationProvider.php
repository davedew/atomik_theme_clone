...
use Concrete\Package\AtomikThemeClone\Theme\AtomikClone\PageTheme;
...
use Concrete\Core\Page\Theme\Documentation\ThemeCategoryDocumentationPage;

class AtomikCloneDocumentationProvider implements DocumentationProviderInterface
{
